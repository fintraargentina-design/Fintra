...
export default function ConclusionTab({
  ...
  return (
    <div className="flex flex-col gap-6 bg-[#0a0a0a] min-h-[600px] text-white p-4 animate-in fade-in duration-300">
      ...
      <section className="bg-[#111827] border border-zinc-800 rounded-lg overflow-hidden shadow-sm">
        ...
        <div className="px-6 py-5 space-y-4 text-sm leading-relaxed text-zinc-100 bg-gradient-to-b from-[#111827] to-[#0a0a0a]">
          ...
          <div className="mt-6 pt-4 border-t border-zinc-800/50 text-[11px] text-zinc-500 italic flex justify-center">
