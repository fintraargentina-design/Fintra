...
export default function ScenariosTab({
  ...
  return (
    <div className="flex flex-col gap-4 bg-[#0a0a0a] min-h-[600px] text-white p-4 animate-in fade-in duration-300">
        ...
        <section className="bg-[#111827] border border-zinc-800 rounded-lg overflow-hidden">
          ...
          <div className="p-5 grid grid-cols-1 md:grid-cols-2 gap-4">
            {alternativeScenarios.map((scenario, idx) => (
              <div 
                key={idx}
                className="bg-black/20 border border-zinc-800/50 rounded p-4 hover:border-zinc-700/50 transition-colors"
              >
      ...
      <section className="bg-[#111827] border border-zinc-800 rounded-lg overflow-hidden">
        ...
        <div className="p-5">
            <div className="mb-4 text-[12px] text-zinc-400 border-b border-zinc-800 pb-2">
          ...
          {hasSensitivities ? (
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
              {sensitivities!.map((item, idx) => (
                <div
                  key={idx}
                  className="flex items-center justify-between bg-black/40 border border-zinc-800/70 rounded px-4 py-3"
                >
