...
* **Persistencia**: Supabase almacena las tablas `analisis_accion`, `stock_proyecciones` y `busquedas_acciones`. Las funciones utilitarias agrupan varias consultas para retornar resultados agregados (datos básicos, análisis y rendimiento) en una única llamada.
