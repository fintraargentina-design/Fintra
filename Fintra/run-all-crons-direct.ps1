...
$jobs += Invoke-CronScript 1 "Sync Universe" "scripts\pipeline\01-sync-universe.ts"
$jobs += Invoke-CronScript 2 "Industry Classification" "scripts\pipeline\02-industry-classification-sync.ts"
...
$jobs += Invoke-CronScript 3 "Prices Daily Bulk" "scripts\pipeline\03-prices-daily-bulk.ts"
$jobs += Invoke-CronScript 4 "Financials Bulk" "scripts\pipeline\04-financials-bulk.ts"
$jobs += Invoke-CronScript 5 "TTM Valuation Incremental" "scripts\backfill\backfill-ttm-valuation.ts"
$jobs += Invoke-CronScript 6 "Company Profile Bulk" "scripts\pipeline\05-company-profile-bulk.ts"
...
$jobs += Invoke-CronScript 7 "Industry Performance 1D" "scripts\pipeline\06-industry-performance-aggregator.ts"
$jobs += Invoke-CronScript 8 "Sector Performance 1D" "scripts\pipeline\07-sector-performance-aggregator.ts"
$jobs += Invoke-CronScript 9 "Sector Perf Windows" "scripts\pipeline\08-sector-performance-windows-aggregator.ts"
$jobs += Invoke-CronScript 10 "Industry Perf Windows" "scripts\pipeline\09-industry-performance-windows-aggregator.ts"
$jobs += Invoke-CronScript 11 "Sector PE Aggregator" "scripts\pipeline\10-sector-pe-aggregator.ts"
$jobs += Invoke-CronScript 12 "Industry PE Aggregator" "scripts\pipeline\11-industry-pe-aggregator.ts"
...
$jobs += Invoke-CronScript 13 "Sector Benchmarks" "scripts\pipeline\12-sector-benchmarks.ts"
...
$jobs += Invoke-CronScript 14 "Performance Bulk" "scripts\pipeline\13-performance-bulk.ts"
$jobs += Invoke-CronScript 15 "Market State Bulk" "scripts\pipeline\14-market-state-bulk.ts"
$jobs += Invoke-CronScript 16 "Dividends Bulk V2" "scripts\pipeline\15-dividends-bulk-v2.ts"
...
$jobs += Invoke-CronScript 17 "FMP Bulk Snapshots" "scripts\pipeline\16-fmp-bulk-snapshots.ts"
$jobs += Invoke-CronScript 18 "Healthcheck Snapshots" "scripts\pipeline\17-healthcheck-snapshots.ts"
...
$jobs += Invoke-CronScript 19 "Recompute FGOS All" "scripts\pipeline\18-recompute-fgos-all.ts"
