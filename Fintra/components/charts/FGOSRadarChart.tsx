...
echarts.use([RadarChart, TitleComponent, TooltipComponent, LegendComponent, ToolboxComponent, CanvasRenderer]);
...
export default function FGOSRadarChart({ 
  ...
  useEffect(() => {
    if (isActive) {
      console.log(`[FGOSRadarChart] Updating for symbol: ${symbol}, hasData: ${!!data}`);
    }
  }, [symbol, data, isActive]);
