	   ...
	   <div className="flex flex-row h-full bg-tarjetas overflow-hidden">
        {/* Filters Toolbar - Sidebar */}
           ...
           <div className="mt-auto flex flex-col gap-2 pt-4">
               <Button onClick={handleSearch} disabled={loading} className="w-full h-8 bg-blue-600 hover:bg-blue-700 text-white text-[11px] font-bold rounded-none">
                  {loading ? <FintraLoader size={12} className="mr-2" /> : <><Search className="w-3 h-3 mr-2" /> Run Screener</>}
               </Button>
