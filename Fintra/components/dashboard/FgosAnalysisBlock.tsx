...
export default function FgosAnalysisBlock({
  ...
  return (
    <div className="w-full mt-4 border-t border-[#222] pt-4">
      <h3 className="text-sm font-medium text-zinc-400 mb-3">Análisis IFS</h3>
      
      <div className="flex flex-col gap-4">
        {/* Summary Table */}
        <div className="border border-[#222] rounded-md overflow-hidden bg-[#111]">
          <div className="flex items-center justify-between p-3 divide-x divide-[#222]">
        ...
        <div className="flex items-center">
            <p className="text-sm text-zinc-400 leading-relaxed italic border-l-2 border-[#222] pl-4 py-1">
              "{displayNarrative}"
            </p>
        </div>
      </div>
