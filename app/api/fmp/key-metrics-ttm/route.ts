...
export async function GET(req: Request) {
  try {
    ...
    // FMP v3: /api/v3/key-metrics-ttm/{symbol}
    // Note: FMP v3 endpoints usually use path parameters.
    // We verified that /api/v3/key-metrics-ttm/SYMBOL works.
    ...
    console.error("[/api/fmp/key-metrics-ttm] error:", err?.message || err);
